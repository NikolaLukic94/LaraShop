                          ...
                          <v-card>
                              ...
                              <v-card-actions>
                                  ...
                                  <v-btn
                                      ...
                                      @click="
                                          dialog = false;
                                          updateOrderItemStatusCode({id: props.row.id, name: name})"
                                  >
                                      Update
                                  </v-btn>
                              </v-card-actions>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add New Order Item Status Code</h5>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters('orderItemsStatusCodes', ['getOrderItemStatusCodes'])
        },
        methods: {
            ...mapActions(
                'orderItemsStatusCodes',
                [
                    'setOrderItemStatusCodes',
                    'createOrderItemStatusCode',
